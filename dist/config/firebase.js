"use strict";
/**
 * @file Firebase Admin initialization module for chat server.
 * @description
 ...
 * Firestore client for use in meeting operations.
 *
...
console.log('🔹 [FIREBASE] Cargando configuración para servidor de chat...');
...
/**
 * Firestore client instance to perform database operations for meetings.
...
exports.auth = auth;
console.log('✅ [FIREBASE] Cliente inicializado correctamente para servidor de chat.');
